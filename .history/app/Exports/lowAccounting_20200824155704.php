    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('L5','Valor documental: ');
                $event->sheet->styleCells("L5:M5",
                    array( 'alignment' => ['horizontal' => static::$ALIGNMENT::HORIZONTAL_RIGHT ])
                );

                $event->sheet->mergeCells("N5:P5");
                $event->sheet->setCellValue('N5','Contable');
                $event->sheet->styleCells('N5:P5',
                    array(
                    'alignment' => [
                        'horizontal' => static::$ALIGNMENT::HORIZONTAL_CENTER,
                        'vertical' => static::$ALIGNMENT::VERTICAL_CENTER,
