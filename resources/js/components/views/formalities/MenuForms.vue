<template>
    <div>
        <header-section icon="fas fa-file-signature" title="Archivo de trámite" style="margin-top: 30px">
    ...
    export default {
        ...
        methods:{
            ...
            confirmShipment(type){
                this.$confirm('¿Estas seguro que la información es correcta?', 'Atención', {
